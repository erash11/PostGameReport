...
###################### WEEKLY AND OPPONENT DATA, CHANGE NAMES AND ABR BELOW FOR EACH WEEK##############################
#### Weekly Changes

# opponent from this week, make sure it matches what opponent's name is in cfbfastr
opp_name = "SMU"
# abbreviation, just for purpose of putting it in graphs
opp_abr = "SMU"

# opponent for the following week
next_name = "Samford"
next_abr = "Samford"
...
# Next Opponent Logo
next_logo <- image_read(team_info$logo[team_info$school == next_name])
...
win_plot_data %>%
  ...
  dplyr::select(game_mins_rem,                                                          # Use game seconds remaining
 
########################### CHANGE WP BEFORE IF BU HOME OR AWAY##########################
                away_wp_before) %>%                                                     # Use away win probability
  ...
  geom_hline(yintercept = 0.5, color = "grey", linetype = "dashed") +                   # Set horizontal line
      ...
      ################################################################# ADJUST LOGOS AS NEEDED  
  draw_image(bu_logo,x = -61, y = -.12, width = 6.67, height = 2) +
  draw_image(opp_logo,x = -61, y = -.87, width = 6.67, height = 2) +
  
   ########################################################### CHANGE WP BEFORE IF BU HOME OR AWAY
  scale_color_manual(labels = c("home_wp_before" = "BU"),                             # Set colors manually
...
Baylor started slow in the first quarter, but quickly gained momentum in the second quarter. The Bears maintained a lead throughout the game, with a win probability of over 50% for the majority of the game. The win probability chart shows Baylor's dominance over Kansas, with the Bears having a high chance of winning the game.
...
Offensively, Baylor was able to move the ball effectively against Kansas. The EPA per play was higher than the season average for both passing and running plays. The EPA per play was also higher than the average of Power Four teams for running plays. This indicates that Baylor's offense was able to outperform the average Power Four team in terms of running plays. Baylor exhibited some the best offense of the season. Both the run and pass game were strong, with the pass game being the strongest it has been all season.

<br>

**Compared to Other Baylor Games**

-   As shown in the scatter plot above, the EPA per rush and pass were some of the best all season.

<br>

**Compared to Baylor Season and Power Four**

-   Compared to Power Four teams, Baylor's passing offense significantly out performed the Power Four teams, on average. Additionally, Baylor way over performed their season average.
-   As for running plays, the EPA per play was higher than other Power Four offenses. This result, as it has been over the past five games, outperformed the P4 average.
...
Overall, the Baylor offense had a strong performance against Kansas. The Bears were able to move the ball effectively through both the passing and running game.
...
Baylor performed very well against the pass, for another week in a row. Run performance was well below the season average.

<br>

**Compared to Other Baylor Games**

-   As the scatter plot displays, Baylor didn't perform at their best compared to the season average.

-   Baylor struggled to defend run. This was the worst performance against the run all season.

<br>

**Compared to Baylor Season and Power Four**

-   Compared to other Power Four teams, Baylor's defense performed well against the pass, forcing multiple interceptions.

-   Compared to the season average, Baylor's pass defense was some of the best it has been all season, which played a major factor in the win.

<br>

**Conclusion**

Although the run defense struggled, the pass defense was able to make up for it. The Bears were able to force multiple interceptions and keep the Jayhawks from scoring more points then they did.
...
Kansas is riding a three-game win streak mainly on the back of their run game. Controlling this will be a significant area of emphasis, especially on 3rd and 4th down plays.

<br>

**Compared to Power Four**

-   Looking at the chart of EPA per play by down, the offense considerably over performs compared to the Power Four average in ALL of the categories.
-   Kansas performs very well on 4th down run and pass. With success running the ball on almost every down, they will likely try to keep this going on Saturday.

<br>

**Conclusion**

Based on this data the Bears should be ready for a run heavy attack.
...
Kansas presents a solid defense that could be more susceptible to a strong pass attack than we saw last week.

<br>

**Compared to Power Four**

-   Houston performs worse than the Power Four average in 6/8 of the play type categories, especially on 4th down running plays.
-   The defense seems to struggle in most pass situations from downs 1-3, the exception is 4th Down pass plays.
-   Kansas struggles greatly on 4th Down runs but is the opposite on 4th Down passes where they excel, well above the Power Four average.

<br>

**Conclusion**

-   Baylor should stick to its strong suit, passing the football, complemented with a consistent run game.
-   On 3rd and 4th down, runs should be strongly considered, while passing in late downs (3rd/4th) should be scrutinized.
