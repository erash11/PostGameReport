...
if (length(bu_alt_color) == 0) bu_alt_color <- "#FFB81C"  # Default Baylor gold

# Opponent Main Color
opp_color <- team_info$color[team_info$school == opp_name]
if (length(opp_color) == 0) {
...
if (length(opp_alt_color) == 0) opp_alt_color <- "#666666"  # Default gray if not found

# Next Opponent Main Color
next_color <- team_info$color[team_info$school == next_name]
if (length(next_color) == 0) {
...
if (length(next_alt_color) == 0) next_alt_color <- "#888888"  # Default gray if not found
